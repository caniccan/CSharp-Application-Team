...
namespace StaticMembersApplication
{
    class Product
    {
    ...
    static class ProductManager
    {
        ...
        static ProductManager()
        {
            ...
            Products[2] = new Product { ProductId = 3, ProductName = "Iphone 7", Price = 4000, IsApproved = false };
            Products[3] = new Product { ProductId = 4, ProductName = "Iphone 8", Price = 5000, IsApproved = false };
            Products[4] = new Product { ProductId = 5, ProductName = "Iphone X", Price = 6000, IsApproved = false };
        }
